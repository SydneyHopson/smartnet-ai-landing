 ...
 * options for normal home coverage. This keeps the preliminary estimate
 * competitive without pretending commercial/plenum hardware costs the same.
 *
 * Commercial jobs retain the higher-spec baseline for cable, racks, UPS,
 * cameras and related infrastructure.
 */
export const pricingCatalog: CatalogItem[] = [
  // Residential/value surveillance. These are conservative acquisition
  // allowances for reputable ONVIF/PoE-class equipment, not a promise of a
  // specific marketplace SKU. Final brand/model is confirmed in proposal.
  ...
  // Keep reliable switching/network core in both tiers.
  ...
  // Residential value infrastructure.
